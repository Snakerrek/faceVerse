...
class User(db.Model):
    ...
    def set_password(self, password):
        self.password_hash = generate_password_hash(password, method='pbkdf2:sha256') # Added method for stronger hashing [2]

    # Method to check a plain text password against the stored hash
